...
class PDFReportGenerator:
    ...
    def generate_report(
        ...
        meta_data = [
            ...
            ["Prepared By:", "HR Analytics AI Engine"],
            ["Date Generated:", datetime.now().strftime("%B %d, %Y")],
            ["Classification:", "Confidential — Internal Management Use"]
        ]
        ...
        story.append(Paragraph(
            "<i>This report has been auto-generated by the Monal Group HR Analytics AI system. "
        ...
        if df_lv.empty:
            ...
            chart_reason = self._build_donut_chart(
                ...
                title="Attrition by AI-Classified Separation Category"
            )
        ...
        disclaimer_text = [
            "This report was auto-generated by the <b>Monal Group HR Analytics AI Engine</b>.",
            ...
            "AI-classified separation categories are based on pattern-matching of resignation reasons "
